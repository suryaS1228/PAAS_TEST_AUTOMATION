...
public class MarineGL_RatingCancel extends BaseClass implements API 
{
 MacroInterface macro = null;
 public MarineGL_RatingCancel(PropertiesHandle config) throws SQLException, MacroException
 {
  this.config = config;
