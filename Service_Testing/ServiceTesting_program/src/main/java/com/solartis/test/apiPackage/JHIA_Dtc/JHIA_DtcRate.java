...
public class JHIA_DtcRate extends BaseClass implements API
{
	MacroInterface macro = null;
	public JHIA_DtcRate(PropertiesHandle config) throws APIException
	{
	    try
	    {
			this.config = config;
			...
			{
			macro=new JHIA_DtcRating(config);	
			}
	    }
