...
public class EmbrokerEndorsementReturnMacro extends DBColoumnVerify implements MacroInterface
{	
	protected ExcelOperationsPOI sampleexcel=null;
	protected String Targetpath;
	protected EmbrokerEndorsementReturnMacro trans;
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	
	public EmbrokerEndorsementReturnMacro(PropertiesHandle configFile) throws MacroException
	{
		super(" ");
	...
	public void GenerateExpected(LinkedHashMap<String, String> inputData,PropertiesHandle configFile) throws MacroException
	{
		try
		{
			...
			String RateingModelName = inputData.get("Testdata");
			//String Ratingfile = inputData.get("Ratingfile");
			Targetpath= "R:/RestFullAPIDeliverable/Devolpement/admin/Embroker/Results/RatingModelResult/"+RateingModelName+"Return.xls";
	...
	public void PumpinData(LinkedHashMap<String, String> inputData,PropertiesHandle configFile) throws MacroException
	{
		try
		{
			...
			trans= new EmbrokerEndorsementReturnMacro(configFile);
