...
public class EmbrokerEndorsementMacro extends DBColoumnVerify implements MacroInterface
{	
	protected ExcelOperationsPOI sampleexcel=null;
	protected String Targetpath;
	protected EmbrokerEndorsementMacro trans;
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	
	public EmbrokerEndorsementMacro(PropertiesHandle configFile) throws MacroException
	{
		super(" ");
	...
	public void PumpinData(LinkedHashMap<String, String> inputData,PropertiesHandle configFile) throws MacroException
	{
		try
		{
			...
			trans= new EmbrokerEndorsementMacro(configFile);
