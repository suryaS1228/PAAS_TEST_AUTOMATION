...
public class EmbrokerCancel extends BaseClass implements API
{
	MacroInterface macro = null;
	public EmbrokerCancel(PropertiesHandle config) throws MacroException
	{
		...
		{
		macro=new EmbrokerMacro(config);	
		}
