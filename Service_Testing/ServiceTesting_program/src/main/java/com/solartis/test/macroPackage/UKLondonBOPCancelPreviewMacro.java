...
public class UKLondonBOPCancelPreviewMacro extends DBColoumnVerify implements MacroInterface
{	
	protected ExcelOperationsPOI sampleexcel=null;
	protected String Targetpath;
	protected UKLondonBOPCancelPreviewMacro trans;
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	
	public UKLondonBOPCancelPreviewMacro(PropertiesHandle configFile) throws MacroException
	{
		super(" ");
	...
	public void PumpinData(LinkedHashMap<String, String> inputData,PropertiesHandle configFile) throws MacroException
	{
		try
		{
			...
			trans= new UKLondonBOPCancelPreviewMacro(configFile);
