package com.solartis.test.apiPackage.RebShare;
...
public class RebSharePolicyTransactionHistory extends BaseClass implements API 
{
 MacroInterface macro = null;
 public RebSharePolicyTransactionHistory(PropertiesHandle config) throws SQLException, MacroException
 {
  this.config = config;
