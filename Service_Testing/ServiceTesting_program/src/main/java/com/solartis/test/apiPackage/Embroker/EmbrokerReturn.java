...
import com.solartis.test.macroPackage.EmbrokerReturnMacro;
import com.solartis.test.macroPackage.MacroInterface;
import com.solartis.test.util.api.DBColoumnVerify;
import com.solartis.test.util.api.HttpHandle;
import com.solartis.test.util.api.JsonHandle;

public class EmbrokerReturn extends BaseClass implements API
{
	MacroInterface macro = null;
	public EmbrokerReturn(PropertiesHandle config) throws MacroException
	{
		...
		{
		macro=new EmbrokerReturnMacro(config);	
		}
