package com.solartis.test.report;
...
public class CustomReporter implements IReporter {
	...
	private static final String emailableReportTemplateFile = "/ServiceTesting_program/src/main/java/com/solartis/test/report/customize-report-template.html";
