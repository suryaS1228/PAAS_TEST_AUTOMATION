...
public class StarrGLRenewalRate extends DBColoumnVerify implements MacroInterface
{
	protected ExcelOperationsPOI sampleexcel=null;
	protected String Targetpath;
	protected StarrGLRenewalRate trans;
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	
	public StarrGLRenewalRate()
	{
		
	}
	public StarrGLRenewalRate(PropertiesHandle configFile) throws MacroException
	{
	...
	public void PumpinData(LinkedHashMap<String, String> inputData,PropertiesHandle configFile) throws MacroException
	{
		try
		{
			...
			trans= new StarrGLRenewalRate(configFile);
		 ...
		 while (inputtableiterator.hasNext() && outputtableiterator.hasNext()) 
			{
				...
				{
					MG=new StarrGLRenewalRate(configFile);
