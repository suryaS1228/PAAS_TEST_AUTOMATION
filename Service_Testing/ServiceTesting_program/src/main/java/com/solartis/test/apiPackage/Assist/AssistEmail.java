package com.solartis.test.apiPackage.Assist;
...
public class AssistEmail extends BaseClass implements API
{
	MacroInterface macro = null;
	public AssistEmail(PropertiesHandle config) throws APIException
	{
	    this.config = config;
