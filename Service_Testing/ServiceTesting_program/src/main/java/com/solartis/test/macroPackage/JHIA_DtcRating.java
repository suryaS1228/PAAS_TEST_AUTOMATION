...
public class JHIA_DtcRating extends DBColoumnVerify implements MacroInterface
{
	private static final String Date2 = null;
	protected ExcelOperationsPOI sampleexcel=null;
	protected String Targetpath;
	protected JHIA_DtcRating trans;
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	
	public JHIA_DtcRating()
	{
		
	}
	public JHIA_DtcRating(PropertiesHandle configFile) throws MacroException
	{
	...
	public void PumpinData(LinkedHashMap<String, String> inputData,PropertiesHandle configFile) throws MacroException
	{
		try
		{
			...
			trans= new JHIA_DtcRating(configFile);
...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	
	...
	public static void main(String args[]) throws PropertiesHandleException, DatabaseException, MacroException
	{
		...
		configFile = new PropertiesHandle("E:\\RestFullAPIDeliverable\\Devolpement\\admin\\STARR_JHIADTC\\config\\config.properties");
