...
public class IsoBopNonRenewal extends BaseClass implements API 
{
	public IsoBopNonRenewal(PropertiesHandle config) throws SQLException
	{
		this.config = config;
