...
import com.solartis.test.macroPackage.EmbrokerEndorsementRunoffMacro;
...
public class EmbrokerEndRunoffRate extends BaseClass implements API
{
	MacroInterface macro = null;
	public EmbrokerEndRunoffRate(PropertiesHandle config) throws MacroException
	{
		...
		{
		macro=new EmbrokerEndorsementRunoffMacro(config);	
		}
