...
public class DtcRatingServiceSinglePlan extends BaseClass implements API 
{
 ...
 public void PumpDataToRequest() throws APIException
 {
    	...
    	try
		{
			...
			request = new JsonHandle(config.getProperty("request_location")+input.ReadData("testdata")+"_request_"+input.ReadData("State_code")+"_"+input.ReadData("PlanName")+".json");
 ...
 public void SendAndReceiveData() throws APIException
 {
  ...
  try
  {
    ...
    response = new JsonHandle(config.getProperty("response_location")+input.ReadData("testdata")+"_response_"+input.ReadData("State_code")+"_"+input.ReadData("PlanName")+".json");  
