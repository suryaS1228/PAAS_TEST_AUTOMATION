...
import com.solartis.test.macroPackage.EmbrokerEndorsement2Macro.Alphabet;
import com.solartis.test.util.api.DBColoumnVerify;
import com.solartis.test.util.common.DatabaseOperation;
import com.solartis.test.util.common.ExcelOperationsPOI;

public class EmbrokerEndorsementRunoffMacro extends DBColoumnVerify implements MacroInterface
{	
	protected ExcelOperationsPOI sampleexcel=null;
	protected String Targetpath;
	protected EmbrokerEndorsementRunoffMacro trans;
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	
	public EmbrokerEndorsementRunoffMacro(PropertiesHandle configFile) throws MacroException
	{
		super(" ");
	...
	public void LoadSampleRatingmodel(PropertiesHandle configFile,LinkedHashMap<String, String> inputData) throws MacroException
	{
		try
		{
			...
			Samplepath= "R:/RestFullAPIDeliverable/Devolpement/admin/Embroker/Results/RatingModelResult/"+RateingModelName+"End1.xls";
	...
	public void GenerateExpected(LinkedHashMap<String, String> inputData,PropertiesHandle configFile) throws MacroException
	{
		try
		{
			...
			String RateingModelName = inputData.get("Testdata");
			Targetpath= "R:/RestFullAPIDeliverable/Devolpement/admin/Embroker/Results/RatingModelResult/"+RateingModelName+"End2.xls";
	...
	public void PumpinData(LinkedHashMap<String, String> inputData,PropertiesHandle configFile) throws MacroException
	{
		try
		{
			...
			trans= new EmbrokerEndorsementRunoffMacro(configFile);
			MacroCondVerify = new DBColoumnVerify("conditionChecking");
			//System.out.println("tablePumpinData "+tablePumpinData);
