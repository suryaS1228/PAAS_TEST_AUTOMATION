...
import com.solartis.test.macroPackage.EmbrokerRunoffMacro;
import com.solartis.test.macroPackage.MacroInterface;
import com.solartis.test.util.api.DBColoumnVerify;
import com.solartis.test.util.api.HttpHandle;
import com.solartis.test.util.api.JsonHandle;

public class EmbrokerRunoff extends BaseClass implements API
{
	MacroInterface macro = null;
	public EmbrokerRunoff(PropertiesHandle config) throws MacroException
	{
		...
		{
		macro=new EmbrokerRunoffMacro(config);	
		}
