...
public class SatoriRating extends DBColoumnVerify implements MacroInterface
{
	...
	public SatoriRating(PropertiesHandle configFile) throws MacroException
	{
		super(" ");
...
public static void main(String args[]) throws PropertiesHandleException, DatabaseException, MacroException
{
	...
	configFile = new PropertiesHandle("E:\\RestFullAPIDeliverable\\Devolpement\\admin\\Satori_Rate\\Config\\config.properties");
