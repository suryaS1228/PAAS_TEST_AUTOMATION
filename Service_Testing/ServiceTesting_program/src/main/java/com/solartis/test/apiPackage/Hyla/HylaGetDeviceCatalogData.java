...
public class HylaGetDeviceCatalogData extends BaseClass implements API 
{
	public HylaGetDeviceCatalogData(PropertiesHandle config) throws SQLException
	{
		this.config = config;
	...
	public void AddHeaders(String Token) throws APIException
	{
		try
		{
			...
			http.AddHeader("MODE", "DEV");
			http.AddHeader("OwnerId", "2282");
			http.AddHeader("Environment", "15");
