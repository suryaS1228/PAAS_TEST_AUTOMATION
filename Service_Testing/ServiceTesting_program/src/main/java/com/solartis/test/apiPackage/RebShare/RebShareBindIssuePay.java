...
public class RebShareBindIssuePay extends BaseClass implements API 
{
 MacroInterface macro = null;
 public RebShareBindIssuePay(PropertiesHandle config) throws SQLException, MacroException
 {
  this.config = config;
