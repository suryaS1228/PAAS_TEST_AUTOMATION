...
public class EmbrokerRunoffMacro extends DBColoumnVerify implements MacroInterface
{	
	protected ExcelOperationsPOI sampleexcel=null;
	protected String Targetpath;
	protected EmbrokerRunoffMacro trans;
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	
	public EmbrokerRunoffMacro(PropertiesHandle configFile) throws MacroException
	{
		super(" ");
	...
	public void LoadSampleRatingmodel(PropertiesHandle configFile,LinkedHashMap<String, String> inputData) throws MacroException
	{
		try
		{
			...
			Samplepath= "R:/RestFullAPIDeliverable/Devolpement/admin/Embroker/Results/RatingModelResult/"+RateingModelName+"Return.xls";
	...
	public void GenerateExpected(LinkedHashMap<String, String> inputData,PropertiesHandle configFile) throws MacroException
	{
		try
		{
			...
			String RateingModelName = inputData.get("Testdata");
			Targetpath= "R:/RestFullAPIDeliverable/Devolpement/admin/Embroker/Results/RatingModelResult/"+RateingModelName+"Runoff.xls";
	...
	public void PumpinData(LinkedHashMap<String, String> inputData,PropertiesHandle configFile) throws MacroException
	{
		try
		{
			...
			trans= new EmbrokerRunoffMacro(configFile);
