...
public class DtcRatingSinglePlan extends DBColoumnVerify implements MacroInterface
{
	...
	public DtcRatingSinglePlan(PropertiesHandle configFile) throws MacroException
	{
		super(" ");
