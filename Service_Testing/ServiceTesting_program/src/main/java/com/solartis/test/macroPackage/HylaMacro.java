...
public class HylaMacro extends DBColoumnVerify implements MacroInterface
{	
	protected ExcelOperationsPOI sampleexcel=null;
	protected String Targetpath;
	protected HylaMacro trans;
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	
	public HylaMacro(PropertiesHandle configFile) throws MacroException
	{
		super(" ");
	...
	public void LoadSampleRatingmodel(PropertiesHandle configFile,LinkedHashMap<String, String> inputData) throws MacroException
	{
		try
		{
			//String RateingModelName = Lookup(inputData.get("RatingModelVersion"),configFile);
			String RateingModelName ="Hyla";
	...
	public void PumpinData(LinkedHashMap<String, String> inputData,PropertiesHandle configFile) throws MacroException
	{
		try
		{
			...
			trans= new HylaMacro(configFile);
