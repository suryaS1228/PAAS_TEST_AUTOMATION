package com.solartis.test.apiPackage.Assist_JHIA_TravelAggregator;
...
import com.solartis.test.macroPackage.TravelAggregatorRating;
import com.solartis.test.util.api.DBColoumnVerify;
import com.solartis.test.util.api.HttpHandle;


public class TravelAggregator_Save1 extends BaseClass implements API
{
	MacroInterface macro = null;
	public TravelAggregator_Save1(PropertiesHandle config) throws APIException
	{
	    try
	    {
			this.config = config;
			...
			{
			macro=new TravelAggregatorRating(config);	
			}
	    }
