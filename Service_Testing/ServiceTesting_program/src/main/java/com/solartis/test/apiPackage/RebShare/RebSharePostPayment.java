...
public class RebSharePostPayment extends BaseClass implements API 
{
 MacroInterface macro = null;
 public RebSharePostPayment(PropertiesHandle config) throws SQLException, MacroException
 {
  this.config = config;
