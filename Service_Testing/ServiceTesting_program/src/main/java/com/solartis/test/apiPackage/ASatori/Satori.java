package com.solartis.test.apiPackage.ASatori;
...
public class Satori extends BaseClass implements API
{
	MacroInterface macro = null;
	public Satori(PropertiesHandle config) throws APIException
	{
	    try
	    {
			this.config = config;
