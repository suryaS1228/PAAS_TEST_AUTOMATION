...
public class HYLAESCChargeMonthlyPayment extends BaseClass implements API 
{
	public HYLAESCChargeMonthlyPayment(PropertiesHandle config) throws SQLException
	{
		this.config = config;
